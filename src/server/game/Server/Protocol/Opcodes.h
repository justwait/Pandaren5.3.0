...
enum Opcodes
{
    ...
    CMSG_CHANNEL_LIST                                 = 0x047B, // 17128
    ...
    CMSG_CHAR_CREATE                                  = 0x0404,
    CMSG_CHAR_CUSTOMIZE                               = 0x21DE,
    CMSG_CHAR_DELETE                                  = 0x010C,
    CMSG_CHAR_ENUM                                    = 0x0B1D,
    ...
    CMSG_CONTACT_LIST                                 = 0x0000, // 17128
    CMSG_CORPSE_MAP_POSITION_QUERY                    = 0x6205,
    CMSG_CREATURE_QUERY                               = 0x050F, // 17128
    CMSG_DANCE_QUERY                                  = 0x4E07,
    CMSG_DB_QUERY_BULK                                = 0x0149, // 17128
    ...
    CMSG_DISMISS_CONTROLLED_VEHICLE                   = 0x0A56, // 17128
    ...
    CMSG_GAMEOBJECT_QUERY                             = 0x058F, // 17128
    ...
    CMSG_LEARN_TALENT                                 = 0x2002, // 17128
    ...
    CMSG_LOAD_SCREEN                                  = 0x0341, // 17128
    CMSG_LOGOUT_CANCEL                                = 0x20E0,
    CMSG_LOGOUT_REQUEST                               = 0x1150, // 17128
    CMSG_LOG_DISCONNECT                               = 0x09A2,
    CMSG_LOOT                                         = 0x0127,
    ...
    CMSG_MOVE_FALL_RESET                              = 0x0AC3, // 17128
    ...
    CMSG_NPC_TEXT_QUERY                               = 0x009E, // 17128
    CMSG_OBJECT_UPDATE_FAILED                         = 0x0492, // 17128
    CMSG_OBJECT_UPDATE_RESCUED                        = 0x3906,
    CMSG_OFFER_PETITION                               = 0x4817,
    CMSG_OPENING_CINEMATIC                            = 0x0CC0,
    ...
    CMSG_RANDOMIZE_CHAR_NAME                          = 0x091D, // 17128
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES                 = 0x0755,
    CMSG_READ_ITEM                                    = 0x2F16,
    CMSG_REALM_SPLIT                                  = 0x0B48, // 17128
    CMSG_RECLAIM_CORPSE                               = 0x4036,
    CMSG_REDIRECTION_AUTH_PROOF                       = 0x1AA1, // 17128
    ...
    CMSG_SET_ACTION_BUTTON                            = 0x0400, // 17128
    CMSG_SET_ACTIVE_MOVER                             = 0x0A53, // 17128
    ...
    CMSG_SET_SELECTION                                = 0x1759, // 17128
    ...
    CMSG_VIOLENCE_LEVEL                               = 0x054B, // 17128
    ...
    MSG_MOVE_SET_WALK_MODE                            = 0x0856, // 17128
    MSG_MOVE_SET_WALK_SPEED_CHEAT                     = 0x0000,
    MSG_MOVE_START_ASCEND                             = 0x089F, // 17128
    MSG_MOVE_START_BACKWARD                           = 0x08D2, // 17128
    MSG_MOVE_START_DESCEND                            = 0x0893, // 17128
    MSG_MOVE_START_FORWARD                            = 0x0A4B, // 17128
    MSG_MOVE_START_PITCH_DOWN                         = 0x0A12, // 17128
    MSG_MOVE_START_PITCH_UP                           = 0x0C02, // 17128
    MSG_MOVE_START_STRAFE_LEFT                        = 0x0816, // 17128
    MSG_MOVE_START_STRAFE_RIGHT                       = 0x0843, // 17128
    MSG_MOVE_START_SWIM                               = 0x0C13, // 17128
    MSG_MOVE_START_TURN_LEFT                          = 0x0A9E, // 17128
    MSG_MOVE_START_TURN_RIGHT                         = 0x0A07, // 17128
    MSG_MOVE_STOP                                     = 0x0813, // 17128
    MSG_MOVE_STOP_ASCEND                              = 0x0A47, // 17128
    MSG_MOVE_STOP_PITCH                               = 0x0AC7, // 17128
    MSG_MOVE_STOP_STRAFE                              = 0x0A4A, // 17128
    MSG_MOVE_STOP_SWIM                                = 0x0C93, // 17128
    MSG_MOVE_STOP_TURN                                = 0x080A, // 17128
    ...
    MSG_RAID_READY_CHECK                              = 0x0DDC, // 17128
    MSG_RAID_READY_CHECK_CONFIRM                      = 0x03C9, // 17128
    MSG_RAID_READY_CHECK_FINISHED                     = 0x1591, // 17128
    ...
    MSG_VERIFY_CONNECTIVITY                           = 0x4F57, // 17128
    SMSG_ACCOUNT_DATA_TIMES                           = 0x0CD1, // 17128
    SMSG_ACCOUNT_INFO_RESPONSE                        = 0x0FC9, // 17128
    SMSG_ACCOUNT_RESTRICTED_WARNING                   = 0x51A7,
    SMSG_ACHIEVEMENT_DELETED                          = 0x6A16,
    SMSG_ACHIEVEMENT_EARNED                           = 0x029D, // 17128
    SMSG_ACTION_BUTTONS                               = 0x019C, // 17128
    SMSG_ACTIVATETAXIREPLY                            = 0x6A37,
    SMSG_ADDON_INFO                                   = 0x0C80, // 17128
    SMSG_ADD_RUNE_POWER                               = 0x6915,
    SMSG_AI_REACTION                                  = 0x0637,
    SMSG_ALL_ACHIEVEMENT_DATA                         = 0x12D1, // 17128
    SMSG_AREA_SPIRIT_HEALER_TIME                      = 0x0734,
    SMSG_AREA_TRIGGER_MESSAGE                         = 0x4505,
    SMSG_AREA_TRIGGER_MOVEMENT_UPDATE                 = 0x0A91, // 17128
    SMSG_ARENA_ERROR                                  = 0x2D17,
    SMSG_ARENA_UNIT_DESTROYED                         = 0x2637,
    SMSG_ARENA_TEAM_CHANGE_FAILED_QUEUED              = 0x6E34,
    SMSG_ARENA_TEAM_COMMAND_RESULT                    = 0x06C1, // 17128
    SMSG_ARENA_TEAM_EVENT                             = 0x0617,
    SMSG_ARENA_TEAM_INVITE                            = 0x0F36,
    SMSG_ARENA_TEAM_QUERY_RESPONSE                    = 0x6336,
    SMSG_ARENA_TEAM_ROSTER                            = 0x14C0, // 17128
    SMSG_ARENA_TEAM_STATS                             = 0x4425,
    SMSG_ATTACKERSTATEUPDATE                          = 0x05A5, // 17128
    SMSG_ATTACKSTART                                  = 0x11D5, // 17128
    SMSG_ATTACKSTOP                                   = 0x0690, // 17128
    ...
    SMSG_AURA_UPDATE_ALL                              = 0x6916, // 17128
    SMSG_AUTH_CHALLENGE                               = 0x0221, // 17128
    SMSG_AUTH_RESPONSE                                = 0x0890, // 17128
    SMSG_AVAILABLE_VOICE_CHANNEL                      = 0x2E16,
    SMSG_AVERAGE_ITEM_LEVEL_INFORM                    = 0x04C5, // 17128
    SMSG_BARBER_SHOP_RESULT                           = 0x6125,
    SMSG_BATTLEFIELD_LIST                             = 0x0ACC, // 17128
    SMSG_BATTLEFIELD_MGR_EJECTED                      = 0x0091, // 17128
    SMSG_BATTLEFIELD_MGR_EJECT_PENDING                = 0x0095, // 17128
    SMSG_BATTLEFIELD_MGR_ENTERED                      = 0x06D9, // 17128
    SMSG_BATTLEFIELD_MGR_ENTRY_INVITE                 = 0x14D8, // 17128
    SMSG_BATTLEFIELD_MGR_EXIT_REQUEST                 = 0x05C5, // 17128
    SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                 = 0x0485, // 17128
    SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE       = 0x0D88, // 17128
    SMSG_BATTLEFIELD_MGR_STATE_CHANGE                 = 0x09C1, // 17128
    SMSG_BATTLEFIELD_PLAYER_POSITIONS                 = 0x03CC, // 17128
    SMSG_BATTLEFIELD_PORT_DENIED                      = 0x0F90, // 17128
    SMSG_BATTLEFIELD_RATED_INFO                       = 0x079D, // 17128
    SMSG_BATTLEFIELD_STATUS                           = 0x7DA1,
    SMSG_BATTLEFIELD_STATUS_QUEUED                    = 0x11D1, // 17128
    SMSG_BATTLEFIELD_STATUS_ACTIVE                    = 0x0CD8, // 17128
    SMSG_BATTLEFIELD_STATUS_NEEDCONFIRMATION          = 0x09D5, // 17128
    SMSG_BATTLEFIELD_STATUS_WAITFORGROUPS             = 0x0BDC, // 17128
    SMSG_BATTLEFIELD_STATUS_FAILED                    = 0x0798, // 17128
    SMSG_BATTLEGROUND_INFO_THROTTLED                  = 0x0D9D, // 17128
    SMSG_BATTLEGROUND_PLAYER_JOINED                   = 0x1281, // 17128
    SMSG_BATTLEGROUND_PLAYER_LEFT                     = 0x1581, // 17128
    // MOP Pet Battle
	/*
	...
	*/
    ...
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x078C, // 17128
    SMSG_CALENDAR_UPDATE_INVITE_LIST                  = 0x0000,
    SMSG_CAMERA_SHAKE                                 = 0x4214,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x6436,
    SMSG_CANCEL_COMBAT                                = 0x0281, // 17128
    SMSG_CAST_FAILED                                  = 0x1598, // 17128
    ...
    SMSG_CHANNEL_LIST                                 = 0x052C, // 17128
    SMSG_CHANNEL_MEMBER_COUNT                         = 0x6414,
    SMSG_CHANNEL_NOTIFY                               = 0x0825, // 17128
    SMSG_CHARACTER_LOGIN_FAILED                       = 0x4417,
    SMSG_CHAR_CREATE                                  = 0x1495, // 17128
    SMSG_CHAR_CUSTOMIZE                               = 0x04E0,
    SMSG_CHAR_DELETE                                  = 0x14C1, // 17128
    SMSG_CHAR_ENUM                                    = 0x0FDD, // 17128
    ...
    SMSG_CLIENTCACHE_VERSION                          = 0x1489, // 17128
    ...
    SMSG_CONTACT_LIST                                 = 0x1924, // 17128
    ...
    SMSG_CUSTOM_LOAD_SCREEN                           = 0x03DC, // 17128
    SMSG_DAMAGE_CALC_LOG                              = 0x2436,
    SMSG_DAMAGE_DONE_OBSOLETE                         = 0x0000,
    SMSG_DANCE_QUERY_RESPONSE                         = 0x2F06,
    SMSG_DB_REPLY                                     = 0x00DC, // 17128
    SMSG_DEATH_RELEASE_LOC                            = 0x2F07,
    SMSG_DEBUG_RUNE_REGEN                             = 0x0C9C, // 17128
    SMSG_DEFENSE_MESSAGE                              = 0x0314,
    SMSG_DESTROY_OBJECT                               = 0x04D1, // 17128
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                 = 0x4825,
    SMSG_DIFFERENT_INSTANCE_FROM_PARTY                = 0x0DD5, // 17128
    SMSG_DISENCHANT_CREDIT                            = 0x12C9, // 17128
    SMSG_DISMOUNT                                     = 0x2135,
    SMSG_DISMOUNTRESULT                               = 0x0CC5, // 17128
    SMSG_DISPEL_FAILED                                = 0x0307,
    SMSG_DISPLAY_GAME_ERROR                           = 0x07D5, // 17128
    SMSG_DONT_AUTO_PUSH_SPELLS_TO_ACTION_BAR          = 0x0BD9, // 17128
    ...
    SMSG_EQUIPMENT_SET_SAVED                          = 0x0888, // 17128
    SMSG_EQUIPMENT_SET_USE_RESULT                     = 0x12CD, // 17128
    SMSG_EXPECTED_SPAM_RECORDS                        = 0x4D36,
    SMSG_EXPLORATION_EXPERIENCE                       = 0x0D84, // 17128
    SMSG_FAILED_PLAYER_CONDITION                      = 0x02CD, // 17128
    SMSG_FEATURE_SYSTEM_STATUS                        = 0x15D1, // 17128
    ...
    SMSG_GODMODE                                      = 0x0405, // 17128
    SMSG_GOSSIP_COMPLETE                              = 0x0806,
    SMSG_GOSSIP_MESSAGE                               = 0x13AD, // 17128
    SMSG_GOSSIP_POI                                   = 0x15A7, // 17128
    SMSG_GROUPACTION_THROTTLED                        = 0x1394, // 17128
    SMSG_GROUP_CANCEL                                 = 0x4D25,
    SMSG_GROUP_DECLINE                                = 0x6835,
    SMSG_GROUP_DESTROYED                              = 0x2207,
    SMSG_GROUP_INVITE                                 = 0x11DD, // 17128
    ...
    SMSG_GUILD_REPUTATION_WEEKLY_CAP                  = 0x1A83, // 17128
    SMSG_GUILD_RESET                                  = 0x1CB5,
    SMSG_GUILD_REWARDS_LIST                           = 0x1DB0,
    SMSG_GUILD_ROSTER                                 = 0x0C0A, // 17128
    ...
    SMSG_INVALIDATE_PLAYER                            = 0x0ED5, // 17128
    SMSG_INVALID_PROMOTION_CODE                       = 0x6F25,
    SMSG_INVENTORY_CHANGE_FAILURE                     = 0x2236,
    SMSG_ITEM_ADD_PASSIVE                             = 0x1384, // 17128
    SMSG_ITEM_COOLDOWN                                = 0x4D14,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                     = 0x0799, // 17128
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                  = 0x0F81, // 17128
    SMSG_ITEM_PUSH_RESULT                             = 0x129D, // 17128
    SMSG_ITEM_REFUND_INFO_RESPONSE                    = 0x15A3,
    SMSG_ITEM_REFUND_RESULT                           = 0x06C5, // 17128
    SMSG_ITEM_REMOVE_PASSIVE                          = 0x1298, // 17128
    SMSG_ITEM_SEND_PASSIVE                            = 0x0DDD, // 17128
    SMSG_ITEM_TEXT_QUERY_RESPONSE                     = 0x2725,
    SMSG_ITEM_TIME_UPDATE                             = 0x0CC0, // 17128
    SMSG_JOINED_BATTLEGROUND_QUEUE                    = 0x0000,
    SMSG_KICK_REASON                                  = 0x0000,
    SMSG_LEARNED_DANCE_MOVES                          = 0x0E05,
    SMSG_LEARNED_SPELL                                = 0x058C, // 17128
    SMSG_LEVELUP_INFO                                 = 0x00CD, // 17128
    SMSG_LFG_BOOT_PROPOSAL_UPDATE                     = 0x0F05,
    SMSG_LFG_DISABLED                                 = 0x0895, // 17128
    SMSG_LFG_JOIN_RESULT                              = 0x0291, // 17128
    SMSG_LFG_OFFER_CONTINUE                           = 0x12C4, // 17128
    SMSG_LFG_OPEN_FROM_GOSSIP                         = 0x0000,
    SMSG_LFG_PARTY_INFO                               = 0x048D, // 17128
    SMSG_LFG_PLAYER_INFO                              = 0x07D9, // 17128
    SMSG_LFG_PLAYER_REWARD                            = 0x0E90, // 17128
    SMSG_LFG_PROPOSAL_UPDATE                          = 0x12C8, // 17128
    SMSG_LFG_QUEUE_STATUS                             = 0x0498, // 17128
    SMSG_LFG_ROLE_CHECK_UPDATE                        = 0x08D1, // 17128
    SMSG_LFG_ROLE_CHOSEN                              = 0x6A26,
    SMSG_LFG_SLOT_INVALID                             = 0x119D, // 17128
    SMSG_LFG_TELEPORT_DENIED                          = 0x049D, // 17128
    SMSG_LFG_UPDATE_LIST                              = 0x0000,
    SMSG_LFG_UPDATE_SEARCH                            = 0x54A1,
    SMSG_LFG_UPDATE_STATUS                            = 0x0E98, // 17128
    SMSG_LFG_UPDATE_STATUS_NONE                       = 0x0A89, // 17128
    ...
    SMSG_LOG_XPGAIN                                   = 0x09CD, // 17128
    SMSG_LOOT_ALL_PASSED                              = 0x0DC1, // 17128
    SMSG_LOOT_CLEAR_MONEY                             = 0x2B37,
    SMSG_LOOT_CONTENTS                                = 0x0580, // 17128
    SMSG_LOOT_ITEM_NOTIFY                             = 0x6D15,
    SMSG_LOOT_LIST                                    = 0x1199, // 17128
    SMSG_LOOT_MASTER_LIST                             = 0x0994, // 17128
    SMSG_LOOT_MONEY_NOTIFY                            = 0x0180, // 17128
    SMSG_LOOT_RELEASE_RESPONSE                        = 0x12C1, // 17128
    SMSG_LOOT_REMOVED                                 = 0x0E8C, // 17128
    SMSG_LOOT_RESPONSE                                = 0x08CD, // 17128
    SMSG_LOOT_ROLL                                    = 0x158C, // 17128
    SMSG_LOOT_ROLL_WON                                = 0x0985, // 17128
    SMSG_LOOT_SLOT_CHANGED                            = 0x2935,
    SMSG_LOOT_START_ROLL                              = 0x10C8, // 17128
    SMSG_MAIL_LIST_RESULT                             = 0x4217,
    SMSG_MAP_OBJ_EVENTS                               = 0x0A84, // 17128
    ...
    SMSG_MESSAGECHAT                                  = 0x0699, // 17128
    SMSG_MESSAGE_BOX                                  = 0x14D9, // 17128
    SMSG_MINIGAME_SETUP                               = 0x6727,
    SMSG_MINIGAME_STATE                               = 0x2E17,
    SMSG_MIRRORIMAGE_DATA                             = 0x2634,
    SMSG_MISSILE_CANCEL                               = 0x03CD, // 17128
    ...
    SMSG_MOVE_SET_CAN_FLY                             = 0x0F48, // 17128
    ...
    SMSG_NAME_QUERY_RESPONSE                          = 0x0BD0, // 17128
    SMSG_NEW_TAXI_PATH                                = 0x4B35,
    SMSG_NEW_WORLD                                    = 0x04D9, // 17128
    SMSG_NEW_WORLD_ABORT                              = 0x0399, // 17128
    ...
    SMSG_PAGE_TEXT_QUERY_RESPONSE                     = 0x0384, // 17128
    ...
    SMSG_PETITION_ALREADY_SIGNED                      = 0x10CD, // 17128
    ...
    SMSG_PET_ACTION_FEEDBACK                          = 0x08C4, // 17128
    SMSG_PET_ACTION_SOUND                             = 0x13D1, // 17128
    SMSG_PET_ADDED                                    = 0x0DD4, // 17128
    SMSG_PET_BROKEN                                   = 0x2E27,
    SMSG_PET_CAST_FAILED                              = 0x01D9, // 17128
    SMSG_PET_DISMISS_SOUND                            = 0x0ED1, // 17128
    SMSG_PET_GUIDS                                    = 0x15CD, // 17128
    SMSG_PET_LEARNED_SPELL                            = 0x1594, // 17128
    SMSG_PET_MODE                                     = 0x0085, // 17128
    SMSG_PET_NAME_INVALID                             = 0x0380, // 17128
    SMSG_PET_NAME_QUERY_RESPONSE                      = 0x0198, // 17128
    SMSG_PET_REMOVED_SPELL                            = 0x0F9D, // 17128
    SMSG_PET_RENAMEABLE                               = 0x2B27,
    SMSG_PET_SLOT_UPDATED                             = 0x03C0, // 17128
    SMSG_PET_SPELLS                                   = 0x4114,
    SMSG_PET_TAME_FAILURE                             = 0x0689, // 17128
    SMSG_PET_UPDATE_COMBO_POINTS                      = 0x4325,
    SMSG_PLAYED_TIME                                  = 0x0995, // 17128
    ...
    SMSG_PLAY_SPELL_VISUAL                            = 0x07D0, // 17128
    SMSG_PLAY_SPELL_VISUAL_KIT                        = 0x01C1, // 17128
    SMSG_PLAY_TIME_WARNING                            = 0x4814,
    SMSG_PONG                                         = 0x1121, // 17128
    SMSG_POWER_UPDATE                                 = 0x0DC5, // 17128
    ...
    SMSG_PVP_LOG_DATA                                 = 0x0795, // 17128
    SMSG_PVP_OPTIONS_ENABLED                          = 0x0381, // 17128
    ...
    SMSG_RAID_MARKERS_CHANGED                         = 0x0595, // 17128
    SMSG_RAID_READY_CHECK_THROTTLED_ERROR             = 0x2607,
    SMSG_RAID_SUMMON_FAILED                           = 0x18B6,
    SMSG_RANDOMIZE_CHAR_NAME                          = 0x0AD9, // 17128
    SMSG_RATED_BG_RATING                              = 0x15A1,
    SMSG_RATED_BG_STATS                               = 0x0394, // 17128
    SMSG_READ_ITEM_FAILED                             = 0x0F16,
    SMSG_READ_ITEM_OK                                 = 0x2605,
    SMSG_REALM_SPLIT                                  = 0x0F89, // 17128
    SMSG_REALM_QUERY                                  = 0x10CC, // 17128
    SMSG_REAL_GROUP_UPDATE                            = 0x0F34,
    SMSG_RECEIVED_MAIL                                = 0x2924,
    SMSG_REDIRECT_CLIENT                              = 0x0328, // 17128
    SMSG_REFER_A_FRIEND_EXPIRED                       = 0x4934,
    SMSG_REFER_A_FRIEND_FAILURE                       = 0x2037,
    SMSG_REFORGE_RESULT                               = 0x03D5, // 17128
    SMSG_REMOVED_SPELL                                = 0x02D9, // 17128
    SMSG_REPORT_PVP_AFK_RESULT                        = 0x2D06,
    SMSG_REQUEST_CEMETERY_LIST_RESPONSE               = 0x1389, // 17128
    SMSG_REQUEST_PVP_REWARDS_RESPONSE                 = 0x0389, // 17128
    ...
    SMSG_RESPOND_INSPECT_ACHIEVEMENTS                 = 0x0DD1, // 17128
    SMSG_RESURRECT_REQUEST                            = 0x0FD0, // 17128
    SMSG_RESYNC_RUNES                                 = 0x6224,
    SMSG_ROLE_POLL_BEGIN                              = 0x0CDC, // 17128
    SMSG_RWHOIS                                       = 0x2437,
    SMSG_SELL_ITEM                                    = 0x6105,
	SMSG_SCENARIO_STATE                               = 0x009C, // 17128
	SMSG_SCENARIO_POIS                                = 0x0C88, // 17128
	SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x0295, // 17128
    SMSG_SEND_MAIL_RESULT                             = 0x4927,
    SMSG_SEND_UNLEARN_SPELLS                          = 0x4E25,
    SMSG_SERVERTIME                                   = 0x0789, // 17128
    SMSG_SERVER_FIRST_ACHIEVEMENT                     = 0x6424,
    SMSG_SERVER_INFO_RESPONSE                         = 0x0ED4, // 17128
    SMSG_SERVER_MESSAGE                               = 0x6C04,
    SMSG_SERVER_PERF                                  = 0x74B6,
    SMSG_SET_AI_ANIM_KIT                              = 0x0000,
    SMSG_SET_DF_FAST_LAUNCH_RESULT                    = 0x01C0, // 17128
    ...
    SMSG_SET_FORCED_REACTIONS                         = 0x069D, // 17128
    ...
    SMSG_SHOW_RATINGS                                 = 0x0A85, // 17128
    SMSG_SOCKET_GEMS_RESULT                           = 0x6014,
    SMSG_SOR_START_EXPERIENCE_INCOMPLETE              = 0x11DC, // 17128
    ...
    SMSG_SPELL_FAILURE                                = 0x108C, // 17128
    SMSG_SPELL_GO                                     = 0x0765, // 17128
    SMSG_SPELL_START                                  = 0x1675, // 17128
    ...
    SMSG_STABLE_RESULT                                = 0x118D, // 17128
    SMSG_STANDSTATE_UPDATE                            = 0x6F04,
    SMSG_START_MIRROR_TIMER                           = 0x6824,
    SMSG_START_TIMER                                  = 0x0988, // 17128
    SMSG_STOP_DANCE                                   = 0x4637,
    SMSG_STOP_MIRROR_TIMER                            = 0x0B06,
    SMSG_STREAMING_MOVIE                              = 0x0989, // 17128
    SMSG_SUMMON_CANCEL                                = 0x0B34,
    SMSG_SUMMON_REQUEST                               = 0x079C, // 17128
    SMSG_SUPERCEDED_SPELL                             = 0x0F99, // 17128
    SMSG_SUPPRESS_NPC_GREETINGS                       = 0x0F85, // 17128
    SMSG_SUSPEND_COMMS                                = 0x4140,
    SMSG_SUSPEND_TOKEN_RESPONSE                       = 0x03DD, // 17128
    ...
    SMSG_TEXT_EMOTE                                   = 0x1185, // 17128
    SMSG_THREAT_CLEAR                                 = 0x0199, // 17128
    SMSG_THREAT_REMOVE                                = 0x0EC0, // 17128
    SMSG_THREAT_UPDATE                                = 0x1080, // 17128
    SMSG_TIME_ADJUSTMENT                              = 0x159C, // 17128
    SMSG_TIME_SYNC_REQ                                = 0x0AD4, // 17128
    SMSG_TITLE_EARNED                                 = 0x02D0, // 17128
    SMSG_TOGGLE_XP_GAIN                               = 0x6704,
    SMSG_TOTEM_CREATED                                = 0x2414,
    SMSG_TRADE_STATUS                                 = 0x0DC0, // 17128
    SMSG_TRADE_STATUS_EXTENDED                        = 0x70A2,
    SMSG_TRAINER_BUY_FAILED                           = 0x08C5, // 17128
    SMSG_TRAINER_BUY_SUCCEEDED                        = 0x6A05,
    SMSG_TRAINER_LIST                                 = 0x08C9, // 17128
    SMSG_TRANSFER_ABORTED                             = 0x0537,
    SMSG_TRANSFER_PENDING                             = 0x13CD, // 17128
    SMSG_TRIGGER_CINEMATIC                            = 0x15BE, // 17128
    SMSG_TRIGGER_MOVIE                                = 0x1198, // 17128
    SMSG_TURN_IN_PETITION_RESULTS                     = 0x0F07,
    SMSG_TUTORIAL_FLAGS                               = 0x0D7E, // 17128
    ...
    SMSG_UPDATE_CURRENCY                              = 0x0000, // 17128
    SMSG_UPDATE_CURRENCY_WEEK_LIMIT                   = 0x70A7,
    SMSG_UPDATE_DUNGEON_ENCOUNTER_FOR_LOOT            = 0x03D9, // 17128
    SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT               = 0x4007,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x4915,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x0437,
    SMSG_UPDATE_OBJECT                                = 0x0C65, // 17128
    SMSG_UPDATE_SERVER_PLAYER_POSITION                = 0x0E84, // 17128
    SMSG_UPDATE_WORLD_STATE                           = 0x13C8, // 17128
    SMSG_USERLIST_ADD                                 = 0x13C5, // 17128
    SMSG_USERLIST_REMOVE                              = 0x0899, // 17128
    SMSG_USERLIST_UPDATE                              = 0x0AC5, // 17128
    SMSG_VOICESESSION_FULL                            = 0x6225,
    SMSG_VOICE_CHAT_STATUS                            = 0x07DC, // 17128
    SMSG_VOICE_PARENTAL_CONTROLS                      = 0x0CC9, // 17128
    SMSG_VOICE_SESSION_LEAVE                          = 0x08D0, // 17128
    SMSG_VOICE_SESSION_ROSTER_UPDATE                  = 0x1291, // 17128
    SMSG_VOICE_SET_TALKER_MUTED                       = 0x6E35,
    SMSG_VOID_ITEM_SWAP_RESPONSE                      = 0x78A2,
    SMSG_VOID_STORAGE_CONTENTS                        = 0x0F9C, // 17128
    SMSG_VOID_STORAGE_FAILED                          = 0x078D, // 17128
    SMSG_VOID_STORAGE_TRANSFER_CHANGES                = 0x06C9, // 17128
    SMSG_VOID_TRANSFER_RESULT                         = 0x05C9, // 17128 
    SMSG_WAIT_QUEUE_FINISH                            = 0x06C8, // 17128
    SMSG_WAIT_QUEUE_UPDATE                            = 0x05D1, // 17128
    SMSG_WARDEN_DATA                                  = 0x12D9, // 17128
    SMSG_WARGAME_CHECK_ENTRY                          = 0x3DA4,
    SMSG_WARGAME_REQUEST_SENT                         = 0x0E85, // 17128
    SMSG_WEATHER                                      = 0x1391, // 17128
    SMSG_WEEKLY_LAST_RESET                            = 0x01D4, // 17128
    SMSG_WEEKLY_RESET_CURRENCY                        = 0x3CA1,
    SMSG_WEEKLY_SPELL_USAGE                           = 0x39B7,
    SMSG_WEEKLY_SPELL_USAGE_UPDATE                    = 0x11B5,
    SMSG_WHO                                          = 0x11C0, // 17128
    SMSG_WHOIS                                        = 0x0D89, // 17128
    SMSG_WORLD_SERVER_INFO                            = 0x1091, // 17128
    SMSG_WORLD_STATE_UI_TIMER_UPDATE                  = 0x4A14,
    SMSG_XP_GAIN_ABORTED                              = 0x1188, // 17128
    SMSG_ZONE_UNDER_ATTACK                            = 0x053F, // 17128
};
